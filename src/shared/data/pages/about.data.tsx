...
export const featuresFourAboutTwo: FeaturesProps = {
  ...
  header: {
    title: 'Our values',
    subtitle: `Exceeding expectations in customer service is not just about meeting needs, it's about creating memorable experiences that foster loyalty and satisfaction.`,
  },
  isAfterContent: true,
  columns: 2,
  items: [
